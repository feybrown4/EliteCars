    ...
    public class DbSeeder
    {
        ...
        public static void Seed(ApplicationDbContext context)
        {
            ...
            var roleFaker = new Faker<Role>()
                .RuleFor(r => r.RoleId, f => f.IndexFaker + 1)
                .RuleFor(r => r.RoleName, f => f.Name.JobTitle());

            var permissionFaker = new Faker<Permission>()
                .RuleFor(p => p.PermissionId, f => f.IndexFaker + 1)
                .RuleFor(p => p.PermissionName, f => f.Lorem.Word());

            var rolePermissionFaker = new Faker<RolePermission>()
                .RuleFor(rp => rp.RolePermissionId, f => f.IndexFaker + 1)
                .RuleFor(rp => rp.RoleId, f => f.Random.Int(1, 5))
                .RuleFor(rp => rp.PermissionId, f => f.Random.Int(1, 5));
